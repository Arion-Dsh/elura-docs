...
features:
  ...
  - icon: "02"
    ...
    details: Use ELR2 framing, official client SDKs, protobuf messages, typed handlers, and explicit middleware.
...
| Connect a Rust, C++, or C# client | [Client SDKs](/guides/client-sdks) |
...
::: info Project status
The current documented version is **v0.3.1**, and this site tracks
main-branch capabilities. Official Rust, C++20, and C# / Unity SDKs are
maintained in separate GitHub repositories and are no longer generated by the
CLI. The project remains pre-1.0: pin exact versions in production and review
release notes and compatibility before upgrading.
:::
